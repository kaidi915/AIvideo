...
Auto-archived AI-generated videos from the SOLOTOPIA AI platform.

Each video is stored under a date folder (`YYYY-MM-DD/`) with a companion `.md` file containing the prompt and parameters.
